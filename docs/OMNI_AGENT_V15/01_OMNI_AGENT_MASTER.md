...
- **Một Trạm Duy Nhất**: Một tiến trình ZeroClaw chạy trên thiết bị Android.
- **Đa Vai Trò (Dynamic Roles)**: Agent tự động thay đổi thái độ và kiến thức dựa trên Kỹ năng (Skill) được gọi.
- **Tập Trung Logic**: Mọi yêu cầu từ người dùng được xử lý tập trung, giúp giảm thiểu sai sót do truyền tin giữa các Agent.
...
system_prompt = \"\"\"
Bạn là Omni-Agent, một thực thể AI đa năng được thiết kế để hỗ trợ người dùng.
...
Bạn có quyền tự quyết định sử dụng Kỹ năng (Skill) nào phù hợp nhất để hoàn thành mục tiêu của người dùng.
\"\"\"
...
1. **Tiết Kiệm RAM**: Thiết bị chỉ cần duy trì 1 tiến trình Gateway, giúp RAM rảnh rang cho các tác vụ nặng khác.
2. **Context Tuyệt Đối**: Agent nắm giữ toàn bộ lịch sử cuộc trò chuyện của người dùng, không bị ngắt quãng context như khi chuyển việc qua lại giữa các Agent khác nhau.
