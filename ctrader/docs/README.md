...
⚡ Risk Monitor started (interval: 60s)
```
...
💼 Tài khoản:
• Tổng: 3 (Real: 1 | Demo: 2)
• Kết nối: 3/3 | Autotrade: 3/3
...
🔑 API Keys (3)
━━━━━━━━━━━━━━━━━━━━
🟢 a1b2c3d4 — MT5_Note10 (MT5)
   🔑 izt_4a9f2b8c1d3e5f6a...
   📊 142 requests | 04/11 14:32

🟢 b2c3d4e5 — TradingView_Gold (TRADINGVIEW)
   🔑 izt_7b8c9d0e1f2a3b4c...
   📊 28 requests | 04/11 10:15

🔴 c3d4e5f6 — Old_MT5 (MT5)
   🔑 izt_1a2b3c4d5e6f7a8b...
   📊 0 requests | Chưa dùng
━━━━━━━━━━━━━━━━━━━━
Quản lý: /key on|off|del <id>
```
...
📊 PnL: -500.00
⚠️ Daily max loss vượt: -500.00 <= -500.00
...
### ❌ "Address already in use" (port 7381)
