...
# 6. Radar Quét & Dọn dẹp Port (Bản v17.7 - Nuclear Mode)
echo -e "${YELLOW}[Radar] Đang thanh trừng triệt để tiến trình cũ...${NC}"
...
# Kill sạch theo tên (Nuclear Strike)
killall -9 zeroclaw 2>/dev/null || true
