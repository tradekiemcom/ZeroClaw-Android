...
echo -e "${BLUE}--------------------------------------------------${NC}"
echo -e "${YELLOW}HƯỚNG DẪN 6 BƯỚC KHỞI ĐỘNG OMNI-AGENT:${NC}"
echo -e "  1. ${GREEN}zeroclaw onboard${NC} (Bắt buộc thiết lập)"
...
echo -e "  6. ${GREEN}bash ~/.zeroclaw/ota_sync.sh${NC} (Kích hoạt Đồng bộ OTA)"
echo -e "${BLUE}--------------------------------------------------${NC}"
echo -e "${YELLOW}💡 Ghi chú: Bản v17.4 không để lại bất kỳ tiến trình ngầm nào.${NC}"
echo -e "   Port 42617 đang hoàn toàn trống để anh làm việc."
echo -e "${BLUE}==================================================${NC}"

echo -e "\n✅ \033[32mCÀI ĐẶT HOÀN TẤT - TIẾN TỚI OMNI-AGENT v17.4!\033[0m"
